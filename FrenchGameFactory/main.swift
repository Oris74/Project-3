...
class Game {
    ...
    var nbOfTurn: Int = 0
    init() {
        self.player1 = requestPlayerName(defaultName: "Joueur 1")
        self.player2 = requestPlayerName(defaultName: "Joueur 2")
...
class Teams {
    ...
    func addNewCharacter() {
       let newFighter = Characters()
            ...
            print("\(newFighter.fighterSelected.keys) vient de rejointe l'équipe avec \(newFighter.fighterSelected.values)!")
      }
    ...
    func DisplayTeam() {
        ...
        for teams in listOfCharacters {
            print("\n\(teams.fighterSelected.keys) dispose de \(teams.fighterSelected.values) points de vie !")
        }
    }
}
...
class Characters {
    var fighterSelected: [String: Int]?
    ...
    init() {
        self.fighterSelected =
    }
    func selectCharacter() {
        if (let mYFighter = fighter.randomElement() as?
    }
}
    //****************************************************************
    //***  Class Weapons
